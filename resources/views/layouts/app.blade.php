...
<body class="min-h-screen font-sans antialiased" x-data="{ journalOpen: false }">
    <div class="min-h-screen">
        <main class="relative min-h-screen bg-[var(--color-bg)] pb-28">
            {{ $slot }}
        ...
        <nav class="fixed bottom-6 left-1/2 z-40 flex -translate-x-1/2 items-center gap-1 rounded-full border border-[var(--color-border)] bg-[var(--color-surface)] p-1.5 shadow-lg">
            ...
            <div class="mx-1 h-7 w-px bg-[var(--color-border)]"></div>
